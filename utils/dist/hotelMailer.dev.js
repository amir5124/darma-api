...
function generateBookingPDF(data, paxes) {
  var browser, page, hargaDasar, biayaHandling, alamatHotel, totalHargaFisik, totalFormatted, paymentDate, formatDateIndo, checkIn, checkOut, diffTime, nights, guestNames, requestValue, finalSpecialRequest, htmlContent;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 6:
          page = _context.sent;
          // --- PERBAIKAN DI SINI ---
          // Pastikan mengambil properti yang konsisten dengan mapping di bawah
          hargaDasar = parseFloat(data.totalPrice || 0);
          biayaHandling = parseFloat(data.handlingFee || 0);
          alamatHotel = data.hotelAddress || "-"; // Diubah dari data.hotel_address

          totalHargaFisik = Math.ceil(hargaDasar + biayaHandling);
          totalFormatted = totalHargaFisik.toLocaleString('id-ID');
...
function sendBookingEmails(bookingId) {
  var _ref, _ref2, rows, b, _ref3, _ref4, paxes, pdfData, pdfBuffer, trackingParams, mailOptions;
      ...
      switch (_context2.prev = _context2.next) {
        ...
        case 17:
          ...
          mailOptions = {
            ...
            html: "\n                <div style=\"font-family: 'Segoe UI', sans-serif; max-width: 600px; margin: auto; border: 1px solid #e2e8f0; padding: 30px; border-radius: 16px; color: #1e293b;\">\n                    <h2 style=\"color: #24b3ae; text-align: center;\">Konfirmasi Reservasi \uD83C\uDF89</h2>\n                    <p>Halo <strong>".concat(b.contact_email, "</strong>,</p>\n                    <p>Pesanan hotel Anda telah berhasil diproses. Silakan temukan E-Voucher terlampir.</p>\n                    <div style=\"background-color: #f1f5f9; padding: 15px; border-radius: 8px;\">\n                        Hotel: <strong>").concat(b.hotel_name, "</strong><br>\n                        Ref No: <strong>").concat(b.os_ref_no || 'Processing', "</strong>\n                    </div>\n                    <br>\n                    <p style=\"font-size: 12px; color: #64748b;\">Tunjukkan voucher terlampir saat check-in.</p>\n                </div>\n            "),
            attachments: [{
        ...
        case 24:
          ...
          console.error("[Email Error] ID ".concat(bookingId, ":"), _context2.t0.message);
...
module.exports = {
  ...
  generateBookingPDF: generateBookingPDF
};