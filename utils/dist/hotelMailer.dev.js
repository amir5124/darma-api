    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          alamatHotel = data.hotelAddress || "-"; // Total Akhir
          ...
          nights = Math.ceil(diffTime / (1000 * 60 * 60 * 24)) || 1; // 3. Daftar Tamu
        ...
        case 31:
          ...
          console.error("❌ [PDF ERROR]:", _context.t0);
          throw _context.t0;
  ...
  return regeneratorRuntime.async(function sendBookingEmails$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          console.log("\uD83D\uDCE7 [MAILER] Starting email process for Booking ID: ".concat(bookingId)); // 1. Ambil data booking terbaru (Agar OS Ref No terbaru terbawa)
        ...
        case 4:
          ...
          console.error("\u274C [MAIL ERROR] Booking ID ".concat(bookingId, " not found."));
        ...
        case 25:
          console.log("\u2705 [Email Sent] Success for Ref: ".concat(b.os_ref_no || b.reservation_no));
          _context2.next = 31;
          break;
        ...
        case 28:
          ...
          console.error("\u274C [Email Error] Failed for ID ".concat(bookingId, ":"), _context2.t0.message);
