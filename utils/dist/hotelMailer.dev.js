    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          biayaHandling = parseFloat(data.handlingFee || data.handling_fee || 0); // 🔧 FIX: sebelumnya cuma baca data.hotel_address (snake_case), padahal
          ...
          alamatHotel = data.hotelAddress || data.hotel_address || 'Alamat hotel tersedia di sistem';
...
function sendBookingEmails(bookingId) {
  var _ref, _ref2, rows, b, _ref3, _ref4, paxes, guestFirstName, greetingName, pdfData, pdfBuffer, trackingParams, statusTrackingUrl, mailOptions;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 14:
          ...
          guestFirstName = paxes && paxes[0] && paxes[0].firstName ? paxes[0].firstName : null;
          greetingName = guestFirstName || b.contact_name || 'Pelanggan Setia';
          pdfData = {
