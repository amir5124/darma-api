    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          biayaHandling = parseFloat(data.handlingFee || data.handling_fee || 0); // Total Akhir
          ...
          nights = Math.ceil(diffTime / (1000 * 60 * 60 * 24)) || 1; // Daftar Tamu

          guestNames = paxes && paxes.length > 0 ? paxes.map(function (p) {
            return "".concat(p.title || p.pax_title || '', " ").concat(p.firstName || p.first_name || '', " ").concat(p.lastName || p.last_name || '');
          }).join(', ') : "Guest";
...
function sendBookingEmails(bookingId) {
  var _ref, _ref2, rows, bookingData, _ref3, _ref4, paxes, pdfBuffer, mailOptions;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          console.error("Booking with ID ".concat(bookingId, " not found."));
        ...
        case 12:
          ...
          paxes = _ref4[0];
          _context2.next = 17;
          return regeneratorRuntime.awrap(generateBookingPDF(bookingData, paxes));
        ...
        case 17:
          ...
          mailOptions = {
            ...
            html: "\n                <p>Halo \uD83D\uDE0A</p>\n                <p>Terima kasih, pembayaran Anda telah kami terima.</p>\n                <p>Berikut kami lampirkan <b>Voucher Hotel</b> Anda untuk nomor reservasi: <b>".concat(bookingData.reservation_no, "</b>.</p>\n                <p>Silakan tunjukkan voucher ini saat proses check-in di hotel.</p>\n                <br>\n                <p>Salam hangat,<br>LinkU Nusantara \uD83D\uDC99</p>\n            "),
            attachments: [{
              filename: "E-Tiket-".concat(bookingData.reservation_no, ".pdf"),
              content: pdfBuffer
            }]
          };
          _context2.next = 21;
        ...
        case 21:
          console.log("Email successfully sent to ".concat(bookingData.contact_email, " for Booking ID: ").concat(bookingId));
          _context2.next = 27;
          break;
        ...
        case 24:
          ...
          console.error("Failed to send booking email:", _context2.t0);
