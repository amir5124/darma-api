...
var hotelController = {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 5;
            return regeneratorRuntime.awrap(api.post("".concat(BASE_URL, "/Hotel/Search5"), payload, {
              httpsAgent: agent,
              headers: {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 5;
            return regeneratorRuntime.awrap(api.post("".concat(BASE_URL, "/Hotel/AvailableRooms5"), payload, {
              httpsAgent: agent
            }));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 5;
            return regeneratorRuntime.awrap(api.post("".concat(BASE_URL, "/Hotel/PriceAndPolicyInfo"), payload, {
              httpsAgent: agent
            }));
  ...
  booking: function booking(req, res) {
    var connection, b, payload, response, resData, _ref, _ref2, bookingResult, newBookingId, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, room, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, pax, pdfData;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 4:
            ...
            _context6.next = 7;
            return regeneratorRuntime.awrap(api.post("".concat(BASE_URL, "/Hotel/BookingAllSupplier"), payload, {
              httpsAgent: agent,
              timeout: 30000
            }));
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            _context9.next = 5;
            return regeneratorRuntime.awrap(api.post("".concat(BASE_URL, "/Hotel/BookingDetail"), payload, {
              httpsAgent: agent
            }));
    ...
    return regeneratorRuntime.async(function getHotelImage$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 4:
            _context10.next = 6;
            return regeneratorRuntime.awrap(api.get("".concat(BASE_URL, "/Hotel/Image?id=").concat(id), {
              httpsAgent: agent,
    ...
    return regeneratorRuntime.async(function getRoomImage$(_context11) {
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 4:
            _context11.next = 6;
            return regeneratorRuntime.awrap(api.get("".concat(BASE_URL, "/Hotel/RoomImage?RoomID=").concat(RoomID), {
              httpsAgent: agent,
              responseType: 'arraybuffer'
            }));
